...
Use SSH port forwarding only. This includes SSH over Tailscale.
...
For a full tailnet walkthrough, see [REMOTE_TAILSCALE.md](./REMOTE_TAILSCALE.md).
...
- Any `HOST`/`HOSTNAME` override to `0.0.0.0` (or non-loopback interface)
